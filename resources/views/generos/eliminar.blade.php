    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">ELIMINAR GENERO</h5>
        </div>
        <div class="modal-body">
          <form action="{{ route('genero.destroy', $genero->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <h4>Estas seguro que deseas eliminar este registro <span class="text-danger">{{ $genero->nombre }}</span></h4>
